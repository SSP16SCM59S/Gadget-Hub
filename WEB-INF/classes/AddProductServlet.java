		...
		String docType = "<!doctype html>\n";
				...
				"<div id='container'>"+
					...
					"<div id='body'>"+
						...
						"<form action='/assign2/addproduct' method='post'  autofocus>"+
							...
							"<input type='text' name='Retailer' required autofocus />"+
							
							"<label>Image (enter the name with extension)</label>"+
							...
							"<input type = 'submit' value='Add Product' class='center' style='margin-left:25px'  />"+
