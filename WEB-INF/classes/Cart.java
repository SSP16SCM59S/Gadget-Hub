...
public class Cart extends HttpServlet 
{
	...
	String username;
	public static HashMap<String,CartDetails> list = new HashMap<>();
				...
				"<div id='container'>"+
					...
					"<nav>"+
						"<ul>"+
							...
							"<li  class='start selected single'><a href='#' style='font-size: 12px'>Cart ("+0+")</a></li>"+
							...
							if(username!=null)
							{
								...
								out.println("<li style='float:right;'><a href='/assign2/Welcome'  style='font-size: 12px'>Welcome, "+username+"</a></li>");
		...
		out.println(	"</ul>"+
					...
					"<div id='body'>"+
						...
						for(String key: list.keySet())
						{
							...
							"<td>"+
							"<form method = 'post' action = '/assign2/deletecart'>"+
