...
public class AccessoriesServlet extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException	
	{
		...
		String fileName = "D:/AccessoryCatalog.xml";
				...
				"<div id='container'>"+
					...
					"<nav>"+
						"<ul>"+
							...
							"<li class='start selected single'><a href='#' style='font-size: 12px'>Accessories</a></li>"+
					...
					"<div id='body'>"+
						...
						"<section id='content'>"+
							...
							"<article>"+
								...
								"<p align='center'>Browse through our collection of Accessories</p>"+
							"</article>"+
