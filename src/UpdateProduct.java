...
public class UpdateProduct extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			//hm_prod.put(objPhoneCatalog.getId(),objPhoneCatalog);
		...
		String docType = "<!doctype html>\n";
				...
				"<div id='container'>"+
					...
					"<nav>"+
						"<ul>"+
							"<div>"+
								"<li><a href='/assign2/store' style='font-size: 10px'>Home</a></li>"+//fill href tags
							"</div>"+
					...
					"<div id='body'>"+
						...
						"<article>"+
								...
								"<p align='center'>Update "+producttype+"</p>"+
							"</article>"+
						...
						for(String key: hm_prod.keySet())
						{
							...
							out.println("<tr>"+
										...
										"</td>"+
										"<td>"+
							"<form method = 'post' action = '/assign2/update2'>"+
							" Id:<br><input type = 'text' value='"+temp1.getId()+"' name='itemid'></p>"+
							"Item Name:<br><input type = 'text' value='"+temp1.getName()+"' name='itemname'></p>"+
							"Retailer:<br><input type = 'text' value='"+temp1.getRetailer()+"'name='itemretailer'></p>"+
							"Condition:<br><input type = 'text' value='"+temp1.getCondition()+"'name='itemcondition'></p>"+
							"Price:<br><input type = 'text' value='"+temp1.getPrice()+"'name='itemprice'></p>"+
