				...
				"<div id='container'>"+
					...
					"<nav>"+
						"<ul>"+
							...
							out.println("<li style='float:right;'><a href='/Signup'  style='font-size: 12px'>Signup</a></li>");
					...
					"<div id='body'>"+
						...
						"<section id='content'>"+
							...
							"<form action='/assign2/Login1' method='post'>"+
							...
							"<input type = 'submit' value='Login' class='center' style='width:180px' autofocus />"+
